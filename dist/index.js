...
var parse = (text, options) => {
  ...
  const parseTag = (parentTagName) => {
    let parsed = {};
    let stringChild = void 0;
    let putasideChild = void 0;
 ...
 * Seller Ships on Payment
   ...
   <item_info>
      ...
      <cpu> </cpu>
      <brand> </brand>
      <description> Visioneer Strobe Pro NT integrates the most advanced paper management software
 ...
 * Seller Ships on Payment
 ...
 this item, however, I will hold shipment of the item for 6 days until the check clears the
 ...
 * Seller Ships on Payment
   ...
   <item_info>
      ...
      <description> With a powerful Intel Celeron? 466MHz (w/128KB L2 Cache) processor the Presario
 5700 is good for everything. You can watch movies, play powerful games, browse the
 Internet at the highest speed available, do your everyday tasks, this computer is good at
 ...
 * Seller Ships on Payment
 ...
 applications, as well as quality, reliability, and compatibility from the world's leading
